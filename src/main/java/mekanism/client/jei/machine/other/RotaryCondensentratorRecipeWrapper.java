...
public class RotaryCondensentratorRecipeWrapper implements IRecipeWrapper
{
	...
	{
		minecraft.fontRenderer.drawString(condensentrating ? LangUtils.localize("gui.mekanism.condensentrating") : LangUtils.localize("gui.mekanism.decondensentrating"), 6-3, 74-12, 0x404040, false);
	}
}
