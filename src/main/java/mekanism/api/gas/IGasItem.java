...
public interface IGasItem
{
	 ...
	 * @param stack - the gasstack of gas to add
	 ...
	 * @param itemstack - the itemstack to get the gas from
	 * @return gas stored
	 */
	 ...
	 * @param itemstack - the itemstack to put gas in
	 * @param stack - the gasstack of gas to add
	 */
	 ...
	 * @param itemstack - the itemstack to get the max gas
	 * @return maximum gas
	 */
