...
public class GuiSolarGenerator extends GuiMekanism
{
	...
	public GuiSolarGenerator(InventoryPlayer inventory, TileEntitySolarGenerator tentity)
	{
		...
		guiElements.add(new GuiEnergyInfo(() -> ListUtils.asList(
                LangUtils.localize("gui.mekanism.producing") + ": " + MekanismUtils.getEnergyDisplay(tileEntity.isActive ? tileEntity.getProduction() : 0) + "/t",
                LangUtils.localize("gui.mekanism.maxOutput") + ": " + MekanismUtils.getEnergyDisplay(tileEntity.getMaxOutput()) + "/t"), this, MekanismUtils.getResource(ResourceType.GUI, "GuiSolarGenerator.png")));
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		fontRenderer.drawString(LangUtils.localize("gui.mekanism.solarGenerator.sun") + ": " + tileEntity.seesSun, 51, 35, 0x00CD00);
